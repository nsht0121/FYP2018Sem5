...
@section('title', trans('backend.newsCategory.subtitle.edit'))
...
<div class="ui breadcrumb">
    ...
    <i class="right chevron icon divider"></i>
    <div class="active section">@lang('backend.newsCategory.subtitle.edit')</div>
</div>
@endsection

@section('content')
<div class="ui top attached inverted center aligned header">
    <p>@lang('backend.newsCategory.subtitle.edit')</p>
</div>
@if ($errors->any())
...
{!! Form::model($newsCategory, ['class' => 'ui form error', 'method' => 'PATCH', 'route' => ['backend.news_categories.update', $newsCategory->id]]) !!}
