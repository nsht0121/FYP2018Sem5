...
@section('title', trans('backend.eventCategory.subtitle.create'))
...
<div class="ui breadcrumb">
    ...
    <i class="right chevron icon divider"></i>
    <div class="active section">@lang('backend.eventCategory.subtitle.create')</div>
</div>
@endsection

@section('content')
<div class="ui top attached inverted center aligned header">
    <p>@lang('backend.eventCategory.subtitle.create')</p>
</div>
@if ($errors->any())
...
{!! Form::open(['class' => 'ui form error', 'method' => 'POST', 'route' => ['backend.event_categories.store']]) !!}
